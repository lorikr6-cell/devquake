...
export function VoiceMenu({ className, round = false }: { className?: string; round?: boolean }) {
  ...
  return (
    <div className={cn('relative flex items-center gap-1', className)}>
      ...
      {open ? (
        <div
          className="fixed inset-0 z-50 flex items-center justify-items-center bg-ink/40 sm:items-center sm:justify-items-center"
        ...
        >
          <div
            ...
            className="w-full space-y-4 rounded-t-2xl bg-paper p-4 pb-[max(1rem,env(safe-area-inset-bottom))] text-ink sm:max-w-sm sm:rounded-2xl dark:bg-ink dark:text-paper"
